...
use Submitty\Submitty\Exceptions\NotImplementedException;
...
use Submitty\Submitty\Models\AdminGradeable;
use Submitty\Submitty\Models\Gradeable;
use Submitty\Submitty\Models\GradeableComponent;
use Submitty\Submitty\Models\GradeableComponentMark;
use Submitty\Submitty\Models\GradeableVersion;
use Submitty\Submitty\Models\User;
use Submitty\Submitty\Models\SimpleLateUser;
use Submitty\Submitty\Models\Team;
use Submitty\Submitty\Models\Course;
use Submitty\Submitty\Models\SimpleStat;
 ...
 *
 * @see \Submitty\Submitty\Exceptions\NotImplementedException
 */
...
WHERE gc_id=? AND gd_id=?", $params);
     ...
     * @param                                $gd_id
     * @param                                $grader_id
     * @param \Submitty\Submitty\Models\GradeableComponent $component
     */
...
WHERE gcm_id=?", $params);
     ...
     *
     * @param \Submitty\Submitty\Models\Gradeable $gradeable
     */
     ...
     * @param string $team_id
     *
     * @return \Submitty\Submitty\Models\Team
     */
