...
namespace Submitty\Submitty\Models;

use PHPUnit\Framework\TestCase;
use Submitty\Submitty\Exceptions\ConfigException;
use Submitty\Submitty\Libraries\Core;
use Submitty\Submitty\Libraries\FileUtils;
use Submitty\Submitty\Libraries\IniParser;
use Submitty\Submitty\Libraries\Utils;

class ConfigTester extends TestCase {
    private $core;
    ...
    /**
     * @expectedException \Submitty\Submitty\Exceptions\ConfigException
