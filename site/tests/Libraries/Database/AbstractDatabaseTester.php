...
use Submitty\Submitty\Exceptions\DatabaseException;
use Submitty\Submitty\Libraries\FileUtils;

class AbstractDatabaseTester extends TestCase {
...
SELECT * FROM test ORDER BY pid");
    ...
    /**
     * @expectedException \Submitty\Submitty\Exceptions\DatabaseException
